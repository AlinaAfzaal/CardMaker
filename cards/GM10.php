...
<script>
  var cardImage = "../CardImages/GM10.webp"; 
</script>
    ...
    <div class="editor mt-1 mb-1" id="editor" style="width: 450px;height: 370px;display: flex;flex-direction: row; margin: auto;overflow: hidden;">
      <div class="image-container" style="position: absolute;width: 450px;height: 370px;overflow:hidden;">
        <img class="cardImage"src="../CardImages/GM10.webp" alt="Example Image" style="width: 100%;height: 100%;"/>
        ...
        <div class="text-overlay" style="top: 170px; left: 120px;">
          <div class="text"  style=" top: 170px; left: 120px;font-size:30px; font-weight: normal; font-family: Great Vibes; text-align: left; color: yellow;  text-transform:normal; font-style:normal;" contenteditable>Happy Marriage!</div>
        </div>
