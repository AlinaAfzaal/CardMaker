  ...
  <div class="carousel-inner">
    ...
    <div class="editor mt-1 mb-1" id="editor1" style="width: 450px;height: 300px;display: flex;flex-direction: row; margin: auto;overflow: hidden;">
      <div class="image-container" style="position: absolute;width: 450px;height: 300px;overflow:hidden;">
        <img class="cardImage"src="../CardImages/PRV1(2).jpeg" alt="Example Image" style="width: 100%;height: 100%;"/>
        ...
        <div class="text-overlay" style="top: 220px; left: 50px; " >
          <div class="text draggable" contenteditable style=" top: 220px; left: 120px; font-size:14px; font-weight: normal; font-family: Verdana; text-align: left; color: #f2c745; text-transform:none; font-style:normal;">Date: </div>
        </div>
    ...
    <div class="editor mt-1 mb-1" id="editor" style="width: 450px;height: 250px;display: flex;flex-direction: row; margin: auto;overflow: hidden;">
      <div class="image-container" style="position: absolute;width: 450px;height: 300px;overflow:hidden;">
        <img class="cardImage"src="../CardImages/PRV1(1).jpeg" alt="Example Image" style="width: 100%;height: 100%;"/>
        <div class="text-overlay" style="top: 130px; left: 100px;">
          <div class="text draggable"  style=" top: 130px; left: 100px;font-size:24px; font-weight: bold; font-family: Chivo Mono; text-align: left; color: #f2c745; text-transform:none; font-style:normal; " contenteditable>Rabta Tech Companies</div>
        </div>
        </div>
      </div>
